...
namespace GaussianSplatting.Editor
{
    ...
    public class GaussianSplatRendererEditor : UnityEditor.Editor
    {
        ...
        SerializedProperty m_PropLocalCenter;// new
        ...
        public void OnEnable()
        {
            ...
            m_PropLocalCenter = serializedObject.FindProperty("m_LocalCenter");// new
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_PropLocalCenter);// new
